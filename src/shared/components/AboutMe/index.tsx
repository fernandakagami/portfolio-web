...
export function AboutMe() {
	...
	return (
		<section className="mx-auto mt-16 flex h-full w-full flex-col items-center justify-evenly px-10 md:px-20 lg:mt-0 lg:h-screen lg:max-w-5xl lg:flex-row lg:px-0">
