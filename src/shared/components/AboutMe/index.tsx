...
export function AboutMe() {
	...
	return (
		<section className="mx-auto flex h-full w-full flex-col items-center justify-evenly px-10 pt-16 md:h-screen md:max-w-5xl md:flex-row md:px-0 md:pt-0">
			<section className="me-0 flex w-full flex-col items-start justify-center gap-1 md:me-10">
